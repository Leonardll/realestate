  ...
  <div className=" section m-auto p-3">
      ...
      <div className="w-100">
          <div className="d-flex pt-1 align-items-center">
              ...
              <p className="card-text fs-6 pt-1 fw-bold">EUR {millify(operation.price)}</p>
          ...
          <div className="d-flex align-items-center">
                                <span className="px-1">{features.bedrooms} <i><FaBed /></i></span>
                                <br />
                                <span className="px-1">{features.bathrooms} <i><FaBath /></i></span> 
                                <br />                                                                              
                                <span className="px-1">{features.constructedArea} sqft<i> <BsGridFill /></i></span> 
                        </div>
          <p className="text mb-2 fs-4 fw-bold  pt-1">{features.$.type}</p>
          <p className="text mb-2 lh-lg  pt-1">{descriptions.description[0].comment}</p>
      </div>
      <div className="div">
