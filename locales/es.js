...
const es = {
  mastheadTitle: "[kõmˈfjãnsa] [sf]",
  mastheadText:
    "Por confianza se entiende la esperanza que se tiene en alguien o en alguna cosa. Es un término que proviene del latín confidere que significa tener fe (fides) en alguien.",
  conciergerieHeader: "Conciergerie",
  conciergerieTitle: "¿Qué necesitas?",
  conciergerieText:
    "Aquí puedes ver los diferentes servicios que ofrecemos. Si no ves lo que estás buscando, no te preocupes, nosotros lo solucionaremos para ti. Podemos encontrarlo todo lo que necesitas, desde tu casa ideal a tu profesor de yoga perfecto.",
  conciergerieData: [
    {
      id: "es personal",
      title: "es personal",
  ...
  propertyTitle: "¿QUÉ BUSCAS?",
  propertyText:
    "Estas son las gestiones más comunes en las que te podemos ayudar, pero recuerda, nosotros como conserje inmobiliarios te ofrecemos un servicio mucho más amplio del que tenemos aquí detallado. Si no ves reﬂejado lo que necesitas, ¡no dudes en contactarnos!",
  propertyData: [
    {
      id: "VENDER",
      ...
      text: [
        {
          id: "pisoideal",
          content:
            "Te acompañamos en la búsqueda de tu piso ideal en todo el mercado de Barcelona",
        },
        {
          id: " diseñodeinteriores",
          content:
            "Te asesoraremos en obras, reformas o diseño de interiores para que quede de ensueño",
        },
      ],
    },
  ],
