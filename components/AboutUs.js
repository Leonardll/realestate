    ...
    <div className="section my-2">
      <div className="container">
        <div className="d-flex justify-content-center">
          <h1 className="my-3 fw-bold text-capitalize" id="about-us">
            About Us
          </h1>
        </div>
        <div className="container">
          <p className=" text-wrap lead">
            ...
            persona de confianza a quien delegas las tareas que no sabes o
            simplemente no quieres gestionar por falta de tiempo o interés.
          </p>
          <p className="lead">
          ...
          <p className="lead">
            Dinos lo que buscas y nos adaptamos a ti para que sea una
            experiencia única. Y descuida, que ofrecemos un servicio en
